...
void onia_to_skim_mc(bool isPr = false, bool isMC = true, long nEvt = -1)
{
  ...
  TString base_name = "";
	if (isPr)
		base_name =  "/data/Oniatree/polarization/oniatree_5p36/PbPb23_MC_Prompt_with_Track/OniaTree_MC1_Run3_PbPb_track_vector_PR/PromptJPsiToMuMu_Pthat2_TuneCP5_HydjetDrumMB_5p36TeV_pythia8/OniaTree_MC1_Run3_PbPb_track_vector_PR/250828_074840/0000/Oniatree_MC_miniAOD";
	else
		base_name =  "/data/Oniatree/polarization/oniatree_5p36/PbPb23_MC_Nonprompt_with_Track/OniaTree_MC1_Run3_PbPb_track_vector_NP/NonPromptJPsiToMuMu_Pthat2_TuneCP5_HydjetDrumMB_5p36TeV_pythia8-evtgen/OniaTree_MC1_Run3_PbPb_track_vector_NP/250829_010938/0000/Oniatree_MC_miniAOD";
  TString nameOldTree = "hionia/myTree";
  TChain oniaTree(nameOldTree);
